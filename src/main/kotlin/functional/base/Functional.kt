...
class AnonymousFunctionalTypeSpecified {
    ...
    val longestOf: (String, String, String) -> String = fun(str1, str2, str3) = maxOf(a = str1, b = str2, c = str3, compareBy { it.length})
}
...
class AnonymousFunctionalTypeInferred {
    ...
    val longestOf = fun(str1: String, str2: String, str3: String) = maxOf(a = str1, b = str2, c = str3, compareBy { it.length})
}
...
class LambdaFunctionalTypeInferred {
    ...
    val longestOf = { str1: String, str2: String, str3: String -> maxOf(a = str1, b = str2, c = str3, compareBy { it.length}) }
}
